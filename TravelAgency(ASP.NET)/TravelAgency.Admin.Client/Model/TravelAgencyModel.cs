...
namespace ELTE.TravelAgency.Admin.Model
{
    ...
    public class TravelAgencyModel : ITravelAgencyModel
    {
        ...
        private Dictionary<BuildingDto, DataFlag> _buildingFlags = new();
        private Dictionary<ImageDto, DataFlag> _imageFlags = new();
        ...
        public void CreateImage(int buildingId, Byte[] imageSmall, Byte[] imageLarge)
        {
        ...
        private void OnBuildingChanged(int buildingId)
        {
