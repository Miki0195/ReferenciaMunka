...
namespace ELTE.TravelAgency.Admin
{
    ...
    {
        private ITravelAgencyModel _model = null!; // initialized during startup
        private LoginViewModel _loginViewModel = null!; // initialized during startup
        private LoginWindow _loginView = null!; // initialized during startup
