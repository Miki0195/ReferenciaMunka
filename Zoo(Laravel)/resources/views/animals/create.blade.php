        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="mb-6">
                        <h1 class="text-2xl font-bold">Create New Animal</h1>
                    </div>
                    ...
                    <form action="{{ route('animals.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="species" id="species" value="{{ old('species') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                            @error('species')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mt-2 space-y-2">
                                <div class="flex items-center">
                                    <input id="is_predator_true" name="is_predator" type="radio" value="1" {{ old('is_predator') == '1' ? 'checked' : '' }} class="h-4 w-4 text-indigo-600 border-gray-300 focus:ring-indigo-500">
                                    <label for="is_predator_true" class="ml-3 block text-sm font-medium text-gray-700">Predator</label>
                                </div>
                                <div class="flex items-center">
                                    <input id="is_predator_false" name="is_predator" type="radio" value="0" {{ old('is_predator') == '0' ? 'checked' : '' }} class="h-4 w-4 text-indigo-600 border-gray-300 focus:ring-indigo-500">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="born_at" id="born_at" value="{{ old('born_at') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                            @error('born_at')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <p class="text-xs text-gray-500 mt-1">Upload an image of the animal (max 2MB).</p>
                            @error('image')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
